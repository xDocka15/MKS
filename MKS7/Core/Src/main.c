...
int main(void)
{
	...
	/* definition and creation of VisualTaks */
	osThreadDef(VisualTaks, StartVisualTask, osPriorityIdle, 0, 128);
	VisualTaksHandle = osThreadCreate(osThread(VisualTaks), NULL);
...
/**
 * @brief Function implementing the VisualTaks thread.
 * @param argument: Not used
 * @retval None
 */
